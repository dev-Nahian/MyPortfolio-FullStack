import Dynamic from "../../assets/Dynamiccenema.png"
...
export default function Themediavault() {
  return (
    <section>
      <div className="py-[80px] xlg:py-[160px] w-full flex justify-center items-center">
        <div className="w-full gap-x-[2%] gap-y-5  flex flex-col-reverse xlg:flex-row justify-between 2xl:items-center px-5 lg:px-10">
          <div className="w-[90%] lg:w-[50%] h-[450px] lg:h-[550px] overflow-y-hidden relative ImageHover">
          ...
          <div className="w-[80%] xlg:w-[46%]">
            <Fade triggerOnce direction="left" duration={2000}>
              <div className="flex flex-col gap-10">
                <HeadingTwo text="The Media Vault"/>
                <SubHeading text="Digital Image and video Selling Website" />
